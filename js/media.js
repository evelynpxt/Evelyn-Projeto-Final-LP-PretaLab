...
function calcularMedia() {
    ...
    const media = (nota1 + nota2 + nota3 + nota4 ); // Variavel para somar as notas
  
   mensagem = ""; // string da media 
   if(media === 0){
    ...
    mensagem = "Hoje é seu aniversario? Porque você ta de parabéns! 10 de média!"
   } else {
    mensagem = " Por favor, insira notas válidas.";
   }
